...
class CreateUTCReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('u_t_c_reports', function (Blueprint $table) {
            $table->id();
               //customer details
    ...
    {
        Schema::dropIfExists('u_t_c_reports');
        Schema::table('interpretations', function (Blueprint $table) {
           $table->dropColumn("defect_no");
        });
    }
}
