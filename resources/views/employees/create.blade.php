            ...
            <div class="card-body">
                <div class="form-row">
                    ...
                    <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-3">
                        ...
                        <select name="designation"  class="form-control form-control-sm select" dropdown="DESIGNATION"></select>
                        @error('entity_id')
                        <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-3">
                        ...
                        <select name="level"  class="form-control form-control-sm select" dropdown="QUALIFICATION_LEVEL"></select>
