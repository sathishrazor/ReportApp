...
<body>
    ...
    <table>
        <tr>
            <td>Type of Penetrant</td>
            <td>{{$record->type_of_penetrant}}</td>
            <td>Method of Removal</td>
            <td>{{$record->type_of_current}}</td>
            <td>Excess Penetrant Removal</td>
        ...
        <tr>
            ...
            <td>Penetrant Batch No.</td>
            <td>{{$record->contrast_batch_no}}</td>
            <td>Developer Batch No.</td>
