...
<form method="POST" enctype="multipart/form-data" action="{{route("lptreport.update",$record->id)}}">
        @csrf
        @method("PUT")
        <h4>Edit LPT Report</h4>
        <div class="form-row">
            <div class="btn-group">
                <button type="submit" class="btn btn-success">Save Changes</button>
                <input type="reset" class="btn btn-warning" value="Reset"/>
                <a href="/lptreport"  class="btn btn-secondary">Back</a>
            </div>
        </div>
        <br />
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-row">
                    <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-3">
                        ...
                        <input name="procedure_no"  value="{{$record->Procedure}}"  type="text" class="form-control form-control-sm autocomplete" dropdown="Procedure No" >
                        @error('procedure_no')
                        <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
            ...
            <div class="card-body">
                <div class="form-row">
                    ...
                    <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <input  name="type_of_penetrant" value="{{$record->type_of_penetrant}}"   type="text"
                    ...
                    <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <input name="method_of_removal" value="{{$record->method_of_removal}}"
                    ...
                    <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <input name="excess_penetrant_removal"  value="{{$record->excess_penetrant_removal}}"
                    ...
                    <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <input name="penetrant_batch_no"  value="{{$record->penetrant_batch_no}}"
                    ...
                    <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <input name="developer_batch_no"  value="{{$record->developer_batch_no}}" type="text"
                    ...
                    <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <input name="white_light_level" value="{{$record->white_light_level}}"  type="text"
                    ...
                    <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <input name="black_light_level" value="{{$record->black_light_level}}"   type="text"
                        class="form-control form-control-sm" dropdown="black_light_level">
                        <small  class="form-text text-muted">intellisense available.</small>
                    </div>
                    <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-2">
                        <label>Light Meter Sr.No</label>
                        <input name="light_meter_sr_no" value="{{$record->light_meter_sr_no}}"  type="text"
                    ...
                    <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <input name="penetrant_dwell_time" value="{{$record->penetrant_dwell_time}}"  type="text"
                    ...
                    <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <input  name="development_time" value="{{$record->development_time}}"
                    ...
                    <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <input name="drying_time"  value="{{$record->drying_time}}"
                    ...
                    <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <input name="drying_aid"  value="{{$record->drying_aid}}"  type="text"
                        class="form-control form-control-sm autocomplete">
                        @error('drying_aid')
                        <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <input name="chemical_manufacturer autocomplete" type="text"  value="{{$record->chemical_manufacturer}}"
            ...
            <div class="card-body card-table">
                <table sublist-attr="interpretations" class="table table-sm table-bordered">
                    ...
                    <tbody>
                        ...
                        <td><input name="interpretations[{{$loop->index}}][drawing_no]"         value="{{$item->drawing_no}}" class="form-control form-control-sm" /></td>
                            <td><input name="interpretations[{{$loop->index}}][line_no]"        value="{{$item->line_no}}"   class="form-control form-control-sm" /></td>
                            <td><input name="interpretations[{{$loop->index}}][joint_no]"       value="{{$item->joint_no}}"  class="form-control form-control-sm" /></td>
                            <td><input name="interpretations[{{$loop->index}}][size]"           value="{{$item->size}}"  class="form-control form-control-sm"/></td>
                            <td><input name="interpretations[{{$loop->index}}][length_thick]"   value="{{$item->length_thick}}" class="form-control form-control-sm" /></td>
                            <td><input name="interpretations[{{$loop->index}}][weld]"           value="{{$item->weld}}"  class="form-control form-control-sm" /></td>
