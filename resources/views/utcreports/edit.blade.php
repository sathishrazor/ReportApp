...
<form method="POST" enctype="multipart/form-data" action="{{route("utcreport.update",$record->id)}}">
        @csrf
        @method("PUT")
        <h4>Edit Ultrasonic Testing C (Lamination) Report</h4>
        <div class="form-row">
            <div class="btn-group">
                <button type="submit" class="btn btn-success">Save Changes</button>
                <input type="reset" class="btn btn-warning" value="Reset"/>
                <a href="{{route("utcreport.index")}}" class="btn btn-secondary">Back</a>
            </div>
        </div>
        <br />
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-row">
                    ...
                    <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-3">
                        ...
                        <input name="drawing_no"  value="{{$record->drawing_no}}" type="text"
            ...
            <div class="card-body">
                <div class="form-row">
                    ...
                    <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <input name="probe_size"   value="{{$record->probe_size}}"  type="text" class="form-control form-control-sm autocomplete" dropdown="probe_size">
                        @error('probe_size')
                        <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <input name="probe_sr_no"   value="{{$record->probe_sr_no}}"   type="text" class="form-control form-control-sm autocomplete" dropdown="probe_sr_no">
                        <small  class="form-text text-muted">intellisense available.</small>
                    </div>
                    <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-2">
                        <label>Step Wedge Sr.No.</label>
                        <input name="stop_wedge_sr_no"   value="{{$record->stop_wedge_sr_no}}"    type="text" class="form-control form-control-sm" dropdown="stop_wedge_sr_no">
                        <small  class="form-text text-muted">intellisense available.</small>
                    </div>
                    <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-2">
                        <label>Couplant</label>
                        <input name="couplant"   value="{{$record->couplant}}"  type="text" class="form-control form-control-sm autocomplete" dropdown="couplant">
                        @error('couplant')
                        <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
        ...
        <div class="card">
            ...
            <div class="card-body card-table">
                ...
                <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-2">
                    ...
                    <input name="remarks"  value="{{$record->remarks}}"  type="text"
            ...
            <div class="card-body">
                <div class="form-row">
                    ...
                    <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <select name="inspected_by" class="form-control form-control-sm select"  value="{{$record->inspected_by}}"  record="employees" ></select>
                        @error('inspected_by')
                        <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <select name="authorised_by" class="form-control form-control-sm select" value="{{$record->authorised_by}}"  record="employees" ></select>
                        @error('authorised_by')
                        <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
